...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='/emwuser/znr/data/detection/yolov5_huaweiche/images/val', help='file/dir/URL/glob, 0 for webcam')
    ...
    parser.add_argument('--save-txt', action='store_true', help='save results to *.txt', default=True)            # 是否要保存txt文件
